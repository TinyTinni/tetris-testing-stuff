...
if (WIN32)
    if(CYGWIN)
        ...
        find_library( GLFW_glfw_LIBRARY_DEBUG
            NAMES
                glfw32d
                glfw32sd
                glfwd
            ...
            PATHS
                ...
                ${OPENGL_LIBRARY_DIR}
            DOC
                "The GLFW debug library"
        )
		find_library( GLFW_glfw_LIBRARY_RELEASE
            NAMES
                glfw32d
                glfw32sd
                glfwd
		...
		select_library_configurations( GLFW_glfw )
    endif()
else ()
    if (APPLE)
        ...
        list(APPEND GLFW_x11_LIBRARY ${X11_Xrandr_LIB} ${X11_Xxf86vm_LIB} ${X11_Xinput_LIB} ${X11_Xkb_LIB})
